...
fields = [
  ...
  %{address: 13022, name: "battery_power", poll_interval_ms: 500, unit: "W"},
  %{
    address: 13021,
  ...
  %{address: 13023, name: "battery_level", poll_interval_ms: 60_000, scale: -1, unit: "%"},
  %{address: 13024, name: "battery_health", poll_interval_ms: 600_000, scale: -1, unit: "%"},
  %{address: 5036, name: "grid_frequency", poll_interval_ms: 60_000, scale: -1, unit: "Hz"},
  %{address: 5019, name: "phase_a_voltage", poll_interval_ms: 60_000, scale: -1, unit: "V"},
  %{address: 13031, name: "phase_a_current", poll_interval_ms: 60_000, scale: -1, unit: "A"},
  %{address: 5011, name: "mppt1_voltage", scale: -1, unit: "V"},
  %{address: 5012, name: "mppt1_current", scale: -1, unit: "A"},
  %{address: 5013, name: "mppt2_voltage", scale: -1, unit: "V"},
  %{address: 5014, name: "mppt2_current", scale: -1, unit: "A"},
  %{
